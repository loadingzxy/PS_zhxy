package com.example.eventbus.demo.util.http;
...
public class OkHttpUtil {
     ...
     * @return
     */
    public static String postForm(String url, Map<String, String> formMap) throws Exception {
        String data = "";
    ...
    private static String execute(OkHttp okHttp) throws Exception {
        ...
        if (okHttp.requestLog) {// 记录请求日志
            log.info("[okhttp][info][{}]", okHttp.toString());
        }
        // 获取请求URL
